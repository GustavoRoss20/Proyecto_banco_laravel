    ...
    <div class="container cform">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form method="post" action="{{ route('download.xml') }}" name="exportar_form" id="exportar_form"
                    class="form-floating">
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" name="XML" id="XML"
                            class="btn btn-outline-primary btn-lg">Descargar xml</button>
                    </div>
                </form>
            </div>
        </div>
